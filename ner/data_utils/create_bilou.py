...
def create_bilou_from_one_document(input_data: dict, data_number: int,
    ...
    for k, pdf_text in enumerate(input_data['pdf_text']):
        ...
        for i, sentence in enumerate(splitted_sentences2):
            ...
            if current_page_annotations:
                ...
                filtered_sentence_annotations = [x for x in
                                                 sorted_sentence_annotations if
                                                 x['annotation'][
                                                     'annotation'] not in [
                                                     'EMAIL', 'PRIS', 'DATO',
                                                     'URL', 'CVR']]
                ...
                for j, annotation in enumerate(filtered_sentence_annotations):
                    ...
                    true_content = sentence[
                                   start_index_init - page_index_diff:end_index_init - page_index_diff]
                    try:
                        if (
                            annotated_content.lower() == true_content.lower()) and \
                            sentence[
                    ...
                    if print_stats:
                        ...
                        if len(pdf_text) > annotation['annotation']['end']:
                            ...
                            print("|" + pdf_text[
                                        annotation['annotation']['end'] - 15:
                                        annotation['annotation'][
                                            'end'] + 15] + "|")
                            print(sentence[annotation['annotation'][
                        ...
                        if true_content.lower() != annotated_content.lower():
                            for skewness in skewness_list:
                                true_content_skewed = sentence[
                                                      start_index_init - page_index_diff + skewness:end_index_init - page_index_diff + skewness]
            ...
            if is_danish:
                ...
                sentence_data.append({"sentence": sentence + '\n',
                                      ...
                                      "page_no": page_num, "sentence_no": i,
                                      "entities": entities})
    ...
    return output_data, [word_tag_mismatch_error, wrong_index, correct_index,
                         ...
                         indices_reindexed, not_danish_counter]
