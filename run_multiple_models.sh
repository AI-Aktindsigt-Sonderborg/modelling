...
python train_mlm_unsupervised_dp.py --train_data train_new_scrape.json --eval_data val_new_scrape.json --epsilon 1 --max_length 32 &
python train_mlm_unsupervised_dp.py --train_data train_new_scrape.json --eval_data val_new_scrape.json --epsilon 1 --max_length 64 &
python train_mlm_unsupervised_dp.py --train_data train_new_scrape.json --eval_data val_new_scrape.json --epsilon 1 --max_length 256 &
python train_mlm_unsupervised_dp.py --train_data train_new_scrape.json --eval_data val_new_scrape.json --epsilon 1 --max_length 512
