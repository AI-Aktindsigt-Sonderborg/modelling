...
python train_mlm_unsupervised.py --max_length 64 --train_data train_1000.json --epsilon 4 --lot_size 36 --evaluate_steps 100 &&
python train_mlm_unsupervised.py --max_length 64 --train_data train_5000.json --epsilon 4 --lot_size 36 --evaluate_steps 500 &&
python train_mlm_unsupervised.py --max_length 64 --train_data train_10000.json --epsilon 4 --lot_size 36 --evaluate_steps 1000 &&
