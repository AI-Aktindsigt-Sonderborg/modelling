...
class ModellingArgParser:
    """
    Class to handle input args for General Modelling.
    Model-parameters:
    :param str --custom_model_dir: Whether to load model from specific directory (default: None)
    :param str --custom_model_name: Whether to give model specific output name (default: None)
    :param bool --save_config: Whether to save input args to file (default: True)
    :param bool --freeze_embeddings: Whether to freeze embeddings layer. Must be freezed for DP at the moment (default: True)
    :param bool --save_model_at_end: Whether to save final model after training. (default: True)
    :param bool --freeze_layers: Whether to freeze all bert layers until freeze_layers_n_steps is reached.True is mandatory for DP at the moment (default: False)
    :param int --freeze_layers_n_steps: Number of steps to train head only - if freeze_layers is true freeze_layers_n_steps must be > 0 (default: 0)
    :param bool --sc_demo: Whether to use model for demo purposes - this is not for training (default: False)
...
learning rate:
    ...
    :param float --lr_freezed: Number of steps to train head only (default:
    0.0005)
